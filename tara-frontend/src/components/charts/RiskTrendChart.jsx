...
const CustomTooltip = ({ active, payload }) => {
  ...
  return (
    <div className="bg-[#F0EEEA] border border-[#E8E5E0] rounded-lg p-3 text-xs">
      <p className="text-[#6B6660] mb-1">{d.name}</p>
  ...
  return (
    <div className="h-[250px] flex flex-col">
      <div className="flex items-center justify-between mb-3 text-[11px]">
        <p className="text-[#6B6660] uppercase tracking-wider">Top Risk Alerts</p>
        <p className="text-[#8A8580]">Showing {chartData.length} of {alerts.length}</p>
      </div>
