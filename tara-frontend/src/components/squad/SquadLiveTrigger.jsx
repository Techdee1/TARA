          ...
          <div key={p.id} className="flex items-center">
            ...
            <div className="flex flex-col items-center gap-1.5">
              <div className={cn(
                ...
                {!isDone && !isActive && (
                  <span className="w-2 h-2 rounded-full bg-[#E8E5E0]" />
                )}
...
function MiniGraph({ nodes, links, newNodeId }) {
  ...
  useEffect(() => {
    ...
    node.append('text')
      ...
      .attr('x', 14).attr('y', 4)
      .attr('fill', '#6B6660').attr('font-size', '9px')
  ...
  return (
    <div className="w-full rounded-xl border border-[#E8E5E0] bg-[#F5F4F1] overflow-hidden">
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[#E8E5E0]">
        <span className="w-1.5 h-1.5 rounded-full bg-[#F97316] animate-pulse" />
        <span className="text-[10px] font-mono text-[#8A8580] uppercase tracking-widest">
          Live Fraud Network
        </span>
        <span className="ml-auto text-[10px] font-mono text-[#8A8580]">
      ...
      {nodes?.length ? (
        ...
        <div className="flex items-center justify-center h-[240px]">
          <p className="text-[11px] font-mono text-[#E8E5E0] uppercase tracking-widest">
    ...
    <div className={cn(
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-lg font-bold text-red-600 tracking-wide leading-tight">
              FRAUD RING DETECTED
            </p>
            <p className="text-xs text-red-300/80 mt-1 space-x-2">
              ...
              {riskPct && (
                <span>· Trust score: <span className="font-semibold text-red-600">{riskPct} risk</span></span>
              )}
            </p>
          </div>
        </div>
        <button
          ...
          className="shrink-0 px-5 py-2 text-sm font-bold rounded-lg bg-red-500 hover:bg-red-600 text-white transition-colors"
        >
          View Full Report →
        </button>
      </div>
...
export function SquadLiveTrigger() {
  ...
  return (
    <div className="w-full">
      ...
      {/* ── Label ── */}
      <p className="text-[11px] font-mono text-[#8A8580] uppercase tracking-widest text-center mb-5">
          ...
          <button
            ...
            className={cn(
              ...
              running || fraudDetected || allDone
                ? 'bg-[#FFFFFF] border-[#E8E5E0] text-[#8A8580] cursor-not-allowed opacity-60'
                : 'bg-[#FFFFFF] border-red-600/60 text-[#1B1A17] hover:border-red-500 hover:bg-red-950/30',
            )}
          >
            {/* Icon */}
            <span className={cn(
              ...
              {running ? (
                <svg className="animate-spin w-4 h-4 text-red-600" viewBox="0 0 24 24" fill="none">
            ...
            <span className="flex flex-col items-start leading-tight">
              ...
              <span className="text-[10px] font-normal text-[#6B6660] tracking-wider">
                {running
            ...
            {!running && !fraudDetected && !allDone && scriptReady && (
              <span className="ml-2 flex items-center gap-1">
                ...
                <span className="text-[10px] text-red-600 font-mono">LIVE</span>
              </span>
            )}
          </button>
        </div>
