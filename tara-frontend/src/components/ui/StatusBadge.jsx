...
const config = {
  OPEN:       { label: 'OPEN',       cls: 'bg-amber-500/10 text-amber-600 border-amber-500/30' },
  IN_REVIEW:  { label: 'IN REVIEW',  cls: 'bg-blue-500/10 text-blue-600 border-blue-500/30' },
  STR_FILED:  { label: 'STR FILED',  cls: 'bg-green-500/10 text-green-600 border-green-500/30' },
  ...
  APPROVED:   { label: 'APPROVED',   cls: 'bg-green-500/10 text-green-600 border-green-500/30' },
  REJECTED:   { label: 'REJECTED',   cls: 'bg-red-500/10 text-red-600 border-red-500/30' },
  FILED:      { label: 'FILED',      cls: 'bg-green-500/10 text-green-600 border-green-500/30' },
}
