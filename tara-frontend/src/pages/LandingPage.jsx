      ...
      <div className="max-w-[1200px] mx-auto px-6 py-4 flex flex-wrap items-center justify-between gap-y-3">
        ...
        <a href="/" className="flex items-center gap-3 no-underline">
          ...
          <span
            ...
            style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700 }}
          >
  ...
  return (
    <div style={{ background: DARK, color: '#F7F9FC' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h1
                ...
                style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 'clamp(2.4rem, 5vw, 3.6rem)', lineHeight: 1.1, color: '#FFFFFF', letterSpacing: '-0.02em' }}
              >
            ...
            <div
              ...
              style={{ background: '#0B0A08', border: '1px solid #2A2822', aspectRatio: '16/10' }}
            >
              <div
                className="flex items-center gap-2 px-4 py-2.5 border-b"
                style={{ borderColor: '#2A2822' }}
              >
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="lg-fade mb-16" style={{ maxWidth: '680px' }}>
            <h2
              ...
              style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', lineHeight: 1.15, color: DARK, letterSpacing: '-0.02em' }}
            >
            ...
            {[
              ...
              >
                ...
                <h3
                  ...
                  style={{ fontSize: '1rem', color: DARK, fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                  {title}
                </h3>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="lg-fade text-center mb-16" style={{ maxWidth: '560px', margin: '0 auto 64px' }}>
            <h2
              ...
              style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', lineHeight: 1.15, color: '#FFFFFF', letterSpacing: '-0.02em' }}
            >
          ...
          {/* Pipeline */}
          <div className="lg-fade grid grid-cols-2 md:grid-cols-5 gap-px rounded-xl overflow-hidden mb-16" style={{ border: '1px solid #2A2822', background: '#2A2822' }}>
            {[
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="lg-fade">
              <h3
                className="font-display mb-5"
                style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: '1.4rem', color: '#FFFFFF', letterSpacing: '-0.01em' }}
              >
            ...
            <div className="lg-fade flex items-center justify-center">
              ...
              <div
                ...
                style={{ background: '#1C1A16', border: '1px solid #2A2822', padding: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '220px' }}
              >
                <img
          ...
          <div className="grid sm:grid-cols-3 gap-5">
              {[
                ...
                >
                  ...
                  <h3
                    className="font-semibold mb-3"
                    style={{ fontSize: '0.975rem', color: DARK, fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                  >
                    {title}
                  </h3>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div
                key={title}
                className="lg-fade rounded-xl p-7"
                style={{ background: '#1C1A16', border: '1px solid #2A2822', transitionDelay: delay }}
              >
                <div
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="lg-fade">
              ...
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                  <path d="M7 1L1 4v3c0 3.31 2.58 6.41 6 7.16C10.42 13.41 13 10.31 13 7V4L7 1z" stroke="#0D9488" strokeWidth="1.5" fill="none" />
                  <path d="M4.5 7l2 2 3-3" stroke="#0D9488" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
      ...
      <section style={{ background: DARK, paddingTop: '120px', paddingBottom: '120px' }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <div className="lg-fade" style={{ maxWidth: '680px', margin: '0 auto' }}>
            <h2
              className="font-display mb-5"
              style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 'clamp(2rem, 4.5vw, 3.2rem)', lineHeight: 1.15, color: '#FFFFFF', letterSpacing: '-0.02em' }}
            >
      ...
      {/* ════════════════════════════════════════════════════════════════════
          SECTION 9 — FOOTER
      ════════════════════════════════════════════════════════════════════ */}
      <footer style={{ background: DARK, borderTop: '1px solid #2A2822', paddingTop: '48px', paddingBottom: '48px' }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid sm:grid-cols-3 gap-10 mb-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <span
                  style={{ fontFamily: "'Space Grotesk', 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: '1.1rem', color: '#FFFFFF' }}
                >
                  TA<span style={{ background: BRAND_GRADIENT, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>RA</span>
                </span>
              </div>
          ...
          <div style={{ borderTop: '1px solid #2A2822', paddingTop: '24px' }}>
